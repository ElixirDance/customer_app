    ...
    <view class="task_container">
        ...
        <view class="task_list">
            <view class="task_item" v-if="taskData?.evpi === 1">
                ...
                <navigator url="/pages/mall/user/profile/index" class="do_task_btn">去完成</navigator>
            </view>
            ...
            <view class="task_item" v-if="taskData?.buyOrder === 1">
                ...
                <navigator url="/pages/mall/cart/index" open-type="switchTab" class="do_task_btn">去完成</navigator>
            </view>
        </view>
    </view>
</template>
